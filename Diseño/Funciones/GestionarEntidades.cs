...
{
    #region Formulario
    public partial class GestionarEntidades : Form
    {
        #region Atributos
        ...
        #region Constructor
        public GestionarEntidades(UInt32 pFRM)
        {
            Sonidos();
            InitializeComponent();
            FRM = pFRM;
        ...
        private void bnObjeto_Click(object sender, EventArgs e)
        {
            DialogResult = DialogResult.OK;
            As.CambiarFormulario(Convert.ToUInt32(((Button)sender).Tag), FRM);
        }
