...
namespace Client
{
    public partial class PublicChatForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Text = "SILA Chat - " + formLogin.txtIP.Text + " - (Connected as: " + formLogin.txtNickname.Text + ")";
        ...
        public void _client_Received(ClientSettings cs, string received)
        {
            ...
            switch (cmd[0])
            {
                case "Users":
                    this.Invoke(() =>
                    {
                        ...
                        for (int i = 1; i < cmd.Length; i++)
                        {
                            ...
                            {
                                ListarUsuarios.Items.Add(cmd[i]);
                            }
                        }
                    });
                    break;
                ...
                case "pMessage":
                    this.Invoke(() =>
                    {
                        pChat.txtReceive.Text += "Server dice: " + cmd[1] + "\r\n";
                    });
                    break;
                case "Disconnect":
                    Application.Exit();
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            if (txtInput.Text != string.Empty)
            {
                ...
                txtReceive.Text += formLogin.txtNickname.Text + " dice: " + txtInput.Text + "\r\n";
